...
exports.RecibirImagenProducto= async (req,res) => {
    ...
    if(!buscarProducto) {
        ...
        const buscarImagen= fs.existsSync(path.join(__dirname,'../public/media/'+buscarProducto.Imagen));
        ...
        {
            try{
                fs.unlinkSync(path.join(__dirname, '../public/media/'+buscarProducto.Imagen));
...
exports.consultarImagenProducto= async (req,res) =>{
    ...
    {
        const imagen= fs.existsSync(path.join(__dirname, '../public/media/'+ buscarImagen.Imagen));
        ...
        {
                 res.sendFile(path.join(__dirname, '../public/media/'+ buscarImagen.Imagen))
        }
    }
}
